...
class SkillGenerator:
    ...
    def generate(
        ...
        for attempt in range(1, self.max_retries + 1):
            ...
            if sandbox_result["success"]:
                ...
                # Save to library RIGHT HERE where code is guaranteed
                if skill_library:
                    try:
                        skill_library.save(
                            name=func_name,
                        ...
                        print(f"  [SKILL] Saved to library: {func_name}")
                    except Exception as e:
    ...
    def get_source(self, tool: Tool) -> str | None:
        """Get source code from a tool generated by this generator."""
        return getattr(tool, "_source_code", self.last_code)
